...
public class PlateRecognition {
	 ...
	 /**
	    ...
	    public String doMain(String[] args){ //public static void main(String[] args){
	    	int sum=3;
	    	int errNum=0;
	    	int sumTime=0;
	    	long longTime=0;
	    	String ret = null;
	    	for(int i=sum;i>0;i--){
		    	String imgPath = "res/image/test_image/plate_detect.jpg"; //识别图片
		    	Mat src = opencv_imgcodecs.imread(imgPath);   //opencv imread函数读入图像
		    	long now =System.currentTimeMillis();   //获取当前系统时间
		    	ret=plateRecognise(src);   //获取识别结果
